      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-8">
          ...
          <div className={`px-4 py-2 rounded-xl flex items-center gap-2 border ${
            report.priority_level === 'CRITICAL' ? 'bg-red-500/20 text-red-400 border-red-500/30 animate-pulse' : 
          ...
          {report.doctor_response ? (
            ...
            <div className="space-y-4">
              <textarea
                ...
                rows={5}
                className="w-full bg-neutral-950 border border-neutral-800 rounded-xl py-3 px-4 text-white placeholder-neutral-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all resize-none"
                placeholder="Enter clinical assessment, prescription notes, and prescribed actions..."
              ></textarea>
